...
<div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6">
    ...
    <section class="py-7">
        <div class="container">
            <h1 class="text-center" style="color: steelblue;">Quản lý chuyến xe</h1>
            <div class="row">
                <div class="table-responsive table-hover">
                    <div class="table-wrapper">
                        <c:url value="/admin/quan-ly-chuyen-xe/search" var="action"></c:url>
                        <form action="${action}">
                            <div class="table-title">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="input-group input-group-outline my-3">
                                            <label class="form-label">Nhập thông tin chuyến xe cần tìm</label>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <c:forEach items="${coachLines}" var="coachLine">
                                <tr>
                                    ...
                                    <td><fmt:formatDate value="${coachLine.departureDate}" pattern="HH:mm:ss - dd/MM/yyyy"/></td>
                                    <td><fmt:formatDate value="${coachLine.arrivalDate}" pattern="HH:mm:ss - dd/MM/yyyy"/></td>
                                    <td>
                                        <a href="<c:url value="/coach-line/"/>?id=${coachLine.id}" class="view"
                                           color:#03A9F4; title="Xem chi tiết chuyến đi" data-toggle="tooltip"><i
                                                style="color:#03A9F4;" class="material-icons">&#xE417;</i></a>
                                        <a href="<c:url value="/admin/coach-line/add-or-update"/>?id=${coachLine.id} " class="edit"
                                           title="Sửa chuyến đi" data-toggle="tooltip"><i class="material-icons"
                                                                                          style="color:#0d376f ;">&#xE254;</i></a>
                                        <a href="<c:url value="/admin/quan-ly-chuyen-xe/delete"/>?id=${coachLine.id}" class="delete"
                                           title="Xoá chuyến đi" data-toggle="tooltip"><i class="material-icons"
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <button type="button" class="btn bg-gradient-light">
                                    <a href="<c:url value="/admin/coach-line/add-or-update"/>">
