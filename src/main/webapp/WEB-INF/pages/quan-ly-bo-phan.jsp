...
<div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6">
    ...
    <section class="py-7">
        <div class="container">
            <h1 class="text-center" style="color: steelblue;">Quản lý bộ phận</h1>
            <div class="row">
                <div class="table-responsive table-hover">
                    <div class="table-wrapper">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <thead>
                            <tr>
                                <th class="th-sm">ID bộ phận
                                </th>
                                <th class="th-sm">Tên bộ phận
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach items="${departments}" var="department">
                                <tr>
                                    ...
                                    <td>
                                        <a href="<c:url value="/admin/department/add-or-update?id=${department.id}"/>"
                                           class="edit" title="Sửa bộ phận" data-toggle="tooltip"><i
                                                class="material-icons" style="color:#0d376f ;">&#xE254;</i></a>
                                        <a href="<c:url value="/admin/department/delete"/>?id=${department.id}"
                                           class="delete" title="Xoá bộ phận" data-toggle="tooltip"><i
                                                class="material-icons" style="color:#E34724 ;">&#xE872;</i>
                                        </a>
                                    </td>
                                </tr>
                            </c:forEach>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <button type="button" class="btn bg-gradient-light">
                                    <a href="<c:url value="/admin/department/add-or-update"/>">
